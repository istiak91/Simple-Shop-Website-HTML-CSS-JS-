const libraryProducts = [
    ...
    { id: 2, name: "মেটাডোর হাই স্কুল কলম", price: "5 টাকা", img: "./images/Library/Matador Hi School.jpg" },
    ...
    { id: 9, name: "গুড লাক এক্সপ্রেস ডিএফ কলম", price: "১০ টাকা", img: "./images/Library/Good Luck Pata.JPG" },
    { id: 10, name: "গুড লাক ক্রেজি বল পয়েন্ট কলম", price: "১০ টাকা", img: "./images/Library/Good Luck Craze.png" },
    { id: 11, name: "মেটাডোর অল টাইম কলম", price: "৬ টাকা", img: "./images/Library/Matador All Time.jpg" },
    { id: 12, name: "মেটাডোর অরবিট লাল কলম", price: "৫ টাকা", img: "./images/Library/Matador Orbit.jpg" },
...
const applicationPrices = [
    ...
    { service: "জন্ম নিবন্ধন আবেদন/সংশোধন", price: "৩০০ টাকা" },
    { service: "পাসপোর্ট আবেদন", price: "১০০০ টাকা" },
    { service: "জমির নামজারি", price: "১০০০ টাকা" },
    { service: "জমির কর প্রদান", price: "৩০০ টাকা" },
    { service: "টিন সার্টিফিকেট আবেদন", price: "৩০০ টাকা" },
    { service: "ড্রাইভিং লাইসেন্স আবেদন", price: "৩০০ টাকা" },
    { service: "অনলাইন GD", price: "৩০০ টাকা" },
    { service: "পত্রিকায় বিজ্ঞাপনের আবেদন", price: "৩০০ টাকা" },
    { service: "বাস এবং ট্রেনের টিকেট কাটা", price: "১০০ টাকা" }
];
